...
func (_q *DependencyQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *DependencyQuery) FirstIDX(ctx context.Context) int {
...
func (_q *DependencyQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *DependencyQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *DependencyQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *DependencyQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(dependency.FieldPackageVersionID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Dependency.Query().
//		Select(dependency.FieldPackageVersionID).
//		Scan(ctx, &v)
